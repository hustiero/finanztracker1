...
function _initUserSheet(ss) {
  ...
  [['Einnahmen',['ID','Datum','Beschreibung','Kategorie','Betrag','Notiz','Deleted','isLohn','GroupID']],
   ...
   ['OEV',     ['ID','Datum','Von','Nach','Preis','Normalpreis','Notiz','Ausserordentlich','AboIDs','Deleted']],
   ['OEV-Abos',['ID','Name','Typ','Kaufdatum','GültigBis','Preis','Guthaben','Notiz','AusgabenID','Deleted']],
